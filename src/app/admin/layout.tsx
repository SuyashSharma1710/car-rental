...
import { LayoutDashboard, Car, Layers, ArrowLeft, Shield } from "lucide-react";
      ...
      <aside className="hidden md:flex w-64 flex-col border-r border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
        <div className="p-6 border-b border-neutral-100 dark:border-neutral-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] font-semibold text-neutral-400">Fleet Operations</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-neutral-100 dark:border-neutral-800">
          <div className="rounded-xl bg-neutral-50 p-3 text-[11px] dark:bg-neutral-950/50 border border-neutral-200 dark:border-neutral-800">
            ...
            <p className="mt-1 text-neutral-400">Database: u249221993_temp_delete</p>
          </div>

          <Link
            href="/"
            className="mt-3 flex items-center justify-center gap-2 rounded-xl border border-neutral-200 py-2 text-xs font-semibold text-neutral-600 hover:bg-neutral-100 dark:border-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-800 transition"
          >
